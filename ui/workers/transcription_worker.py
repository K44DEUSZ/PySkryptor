...
from core.io.text import TextPostprocessor, is_url, sanitize_filename
from core.services.conflict_service import ConflictService
from core.services.download_service import DownloadCancelled, DownloadError, DownloadService
    ...
    def run(self) -> None:
        ...
        try:
            ...
            if self._is_cancelled():
                ...
                self.log.emit("❌ Finished with errors — check the log above.")
            elif processed_any:
