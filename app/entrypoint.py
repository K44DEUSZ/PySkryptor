...
from core.services.app_logging_service import AppLoggingService
...
def run() -> int:
    ...
    log_ctx = AppLoggingService.setup(Config.ROOT_DIR)
    log = log_ctx.logger
    ...
    try:
        ...
        if key == "error.settings.defaults_missing":
            ...
            return 1
        critical_config_load_failed_and_exit(None, str(key))
        return 1
